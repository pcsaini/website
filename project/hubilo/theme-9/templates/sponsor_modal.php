  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div style="display: inline-block;">
        <?php if ($v["sponsor_fb"]) { ?>
          <a href="<?php echo $v["sponsor_fb"]; ?>" class="jx-btn-default jx-outline" style="padding: 0px !important; width: 50px;">
          <i class="fa fa-facebook" aria-hidden="true" style="padding-left: 9px;"></i>
          </a>
        <?php } ?>
        </div>
        <div style="display: inline-block;">
        <?php if($v["sponsor_twitter"] ){ ?>
          <a href="<?php echo $v["sponsor_twitter"]?>" class="jx-btn-default jx-outline" style="padding: 0px !important; width: 50px;">
        ...
        <?php if($v["sponsor_website"] ){ ?>
          <a href="<?php echo $v["sponsor_website"]?>" class="jx-btn-default jx-outline" style="padding: 0px !important; width: 50px;">
