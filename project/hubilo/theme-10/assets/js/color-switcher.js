...
jQuery(document).ready(function($) {
	...
	$("ul.colors .color1" ).click(function(){
		$("#colors" ).attr("href", "assets/css/colors/yello.css" );
		return false;
	});
	...
	$("ul.colors .color3" ).click(function(){
		$("#colors" ).attr("href", "assets/css/colors/cardinal.css" );
		return false;
	});

	$("ul.colors .color4" ).click(function(){
		$("#colors" ).attr("href", "assets/css/colors/coral.css" );
		return false;
	});
	...
	$("ul.colors .color10" ).click(function(){
		$("#colors" ).attr("href", "assets/css/colors/aqua.css" );
		return false;
	});
...
jQuery('head').append('<link rel="stylesheet" id="colors" href="assets/css/colors/yello.css" type="text/css" />');
